    ...
    <main className="flex flex-col justify-center items-center min-w-screen min-h-screen mono">
      <div className="flex flex-col bg-zinc-900 px-6 pb-8 pt-4 overflow-hidden rounded-xl">
        <div className="flex flex-row justify-start items-center w-full px-3 py-6">
          ...
          <span className="text-white text-[4em] px-4">DEPARTURES</span>
        </div>
        <div className="flex flex-row justify-center items-center gap-10">
          <div className="flex flex-col justify-center items-start gap-2 p-2">
            <span className="text-white text-[2em]">ROOM</span>
          ...
          <div className="flex flex-col justify-center items-start gap-2 p-2">
            <span className="text-white text-[2em]">CONFERENCE</span>
          ...
          <div className="flex flex-col justify-center items-start gap-2 p-2">
            <span className="text-white text-[2em]">TIME</span>
